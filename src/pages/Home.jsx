        ...
        <div className="feature-box">
          ...
          <div className="feature-item">
            ...
            <div className="item-text">
              ...
              <h4>Quality Eggs</h4>
              <p>
                We provide farm-fresh, hygienically handled eggs directly from our
                hatcheries to ensure top quality and nutrition for your family.
              </p>
              <a href="#">Shop Now</a>
            </div>
          </div>
          ...
          <div className="feature-item">
            ...
            <div className="item-text">
              ...
              <h4>On-Time Supply</h4>
              <p>
                Get reliable and timely delivery of eggs and hatchery products,
                ensuring freshness and safety at your doorstep.
              </p>
          ...
          <div className="feature-item">
            ...
            <div className="item-text">
              ...
              <h4>Healthy Hatcheries</h4>
              <p>
                Our hatcheries follow eco-friendly and sustainable farming practices,
                keeping both the environment and poultry safe.
              </p>
              <a href="#">Learn More</a>
            </div>
          </div>
